...
let favoriteFoods = ['hot dogs', 'takis', 'nacho fries', 'gyros']
...
console.log('Added a magical food to the end:', favoriteFoods);
...
favoriteFoods.pop();
console.log('I removed Rice:', favoriteFoods);
...
console.log('The foods are now up to date:', favoriteFoods);
